...
_SYSTEM_PROMPT = """
You enrich parsed HTML web documents for a data lake index.

Your job:
- infer concise file-level meaning from the parsed page text
...
def _build_user_prompt(payload: dict[str, Any]) -> str:
    instructions = {
        "rules": [
            "Keep summaries grounded in the provided page text.",
            "Do not invent missing context, dates, or entities.",
            "Prefer concise, retrieval-oriented wording.",
            "File summary should describe what the page contains and what a user can find in it.",
